"""Arix Persistent Memory System — SQLite-backed episodic, preference, project, workflow, and skill memory.
...
from arix.memory.vector_index import VectorIndex

Arix_DIR = Path.home() / ".arix"
MEMORY_DB = Arix_DIR / "memory.db"
PREFS_FILE = Arix_DIR / "user_prefs.json"
...
class MemoryManager:
    """Manages all Arix memory types: episodic, preferences, project, workflow, semantic, skills."""
