"""PACCA Workflow Automation System — natural language workflow builder with APScheduler."""
...
WORKFLOWS_DIR = Path.home() / ".pacca" / "workflows"
...
class WorkflowRegistry:
    """CRUD operations on workflow YAML files in ~/.pacca/workflows/."""
