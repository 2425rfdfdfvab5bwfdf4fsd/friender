...
work with the same browser session as the rest of PACCA's browser tools.
"""
...
def open_web_app(
    ...
    """
    from pacca.tools.browser_tools import BrowserController  # lazy import
...
def list_available_web_apps() -> dict:
    """Return all web apps PACCA can navigate to."""
